...
#define PELTIER_DA_OUT_Pin GPIO_PIN_4
#define PELTIER_DA_OUT_GPIO_Port GPIOA
...
#define PELTIER_PWR_ON_Pin GPIO_PIN_15
#define PELTIER_PWR_ON_GPIO_Port GPIOE
#define MP3_PREVIOUS_VOLMI_Pin GPIO_PIN_12
#define MP3_PREVIOUS_VOLMI_GPIO_Port GPIOB
#define HP1_PELT_ON_Pin GPIO_PIN_8
#define HP1_PELT_ON_GPIO_Port GPIOD
#define COOLING_LV2_Pin GPIO_PIN_9
#define COOLING_LV2_GPIO_Port GPIOD
#define COOLING_LV1_Pin GPIO_PIN_10
#define COOLING_LV1_GPIO_Port GPIOD
#define HP1_PELT_OND11_Pin GPIO_PIN_11
#define HP1_PELT_OND11_GPIO_Port GPIOD
#define RF_GPIO_IN_Pin GPIO_PIN_12
#define RF_GPIO_IN_GPIO_Port GPIOD
#define RF_Pulse_Signal_Pin GPIO_PIN_13
#define RF_Pulse_Signal_GPIO_Port GPIOD
...
#define FOOT_INSERT_GPIO_Port GPIOB
