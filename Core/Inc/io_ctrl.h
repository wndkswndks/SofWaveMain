...
#define BAT_ADC_EN_H()           		HAL_GPIO_WritePin(VBAT_ADC_EN_GPIO_Port, VBAT_ADC_EN_Pin, GPIO_PIN_SET)
#define BAT_ADC_EN_L()            		HAL_GPIO_WritePin(VBAT_ADC_EN_GPIO_Port, VBAT_ADC_EN_Pin, GPIO_PIN_RESET)
